...
> validate_password 컴포넌트를 이용하려면 설치가 필요하다. 이 프로그램은 MySQL 서버 프로그램에 내장되어 있기 때문에 INSTALL COMPONENT 명령의 file:// 부분에 별도의 파일 경로를 지정하지 않아도 된다.
>
> ```sql
...
![image-20230331160741674](/Users/user/Library/Application Support/typora-user-images/image-20230331160741674.png)
